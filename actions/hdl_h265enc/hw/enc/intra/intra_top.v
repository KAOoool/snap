...
intra_ram_dp_32x480  u_frame_ram(
				.clka    (clk),
...
intra_ram_dp_32x64 u_row_ram(
		    ...
		    .dataa_i (w_data_row_w),
				...
				.datab_i ()
                                                                                        ...
                                                                                        // actual depth
intra_ram_dp_32x64 u_column_ram_0(                                                    //      56
				.clka    (clk),
				.cena_i  ( ~( (wena_w)&&(ref_sel_w==2'b00) ) ),
		    .oena_i  (1'b1),
		    .wena_i  ( ~( (wena_w)&&(ref_sel_w==2'b00) ) ),
  ...
  intra_ram_dp_32x64 u_column_ram_1(                                                    //      8
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
  ...
  intra_ram_dp_32x64 u_column_ram_2(                                                    //      8
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
    .cena_i   ( ~( (wena_w)&&(ref_sel_w==2'b00)&&(ref_position_w[7]) )    ),
    .wena_i   ( ~( (wena_w)&&(ref_sel_w==2'b00)&&(ref_position_w[7]) )    ),
...
intra_ram_dp_32x480  u_fram_ram_u(
				.clka    (clk),
...
intra_ram_dp_32x64 u_row_ram_u(
				.clka    (clk),
		    ...
		    .dataa_i (w_data_row_w),
				...
				.datab_i ()
                                                                                          ...
                                                                                          // actual depth
intra_ram_dp_32x64 u_column_ram_0_u(                                                    //      12
				.clka    (clk),
				.cena_i  ( ~( (wena_w)&&(ref_sel_w==2'b10) ) ),
		    .oena_i  (1'b1),
		    .wena_i  ( ~( (wena_w)&&(ref_sel_w==2'b10) ) ),
  ...
  intra_ram_dp_32x64 u_column_ram_1_u(                                                  //      4
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
  ...
  intra_ram_dp_32x64 u_column_ram_2_u(                                                  //      4
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
    .cena_i   ( ~( (wena_w)&&(ref_sel_w==2'b10)&&(ref_position_w[7]) )    ),
    .wena_i   ( ~( (wena_w)&&(ref_sel_w==2'b10)&&(ref_position_w[7]) )    ),
...
intra_ram_dp_32x480  u_fram_ram_v(
				.clka    (clk),
...
intra_ram_dp_32x64 u_row_ram_v(
				.clka    (clk),
		    ...
		    .dataa_i (w_data_row_w),
				...
				.datab_i ()
                                                                                          ...
                                                                                          // actual depth
intra_ram_dp_32x64 u_column_ram_0_v(                                                    //      12
				.clka    (clk),
				.cena_i  ( ~( (wena_w)&&(ref_sel_w==2'b11) ) ),
		    .oena_i  (1'b1),
		    .wena_i  ( ~( (wena_w)&&(ref_sel_w==2'b11) ) ),
  ...
  intra_ram_dp_32x64 u_column_ram_1_v(                                                  //      4
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
  ...
  intra_ram_dp_32x64 u_column_ram_2_v(                                                  //      4
    .clka     ( clk                 ),
    .oena_i   ( 1'b1                ),
    .cena_i   ( ~( (wena_w)&&(ref_sel_w==2'b11)&&(ref_position_w[7]) )    ),
    .wena_i   ( ~( (wena_w)&&(ref_sel_w==2'b11)&&(ref_position_w[7]) )    ),
