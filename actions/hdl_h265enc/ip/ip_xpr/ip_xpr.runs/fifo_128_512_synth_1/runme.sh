...
HD_PWD='/afs/vlsilab.boeblingen.ibm.com/u/lyhlu/vol2/HEVC/snap/actions/hdl_h265enc/ip/ip_xpr/ip_xpr.runs/fifo_128_512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_128_512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_128_512.tcl
